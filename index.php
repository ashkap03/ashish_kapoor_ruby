...
if ($token) {
  ...
  $app_using_friends = FBUtils::fql(
    "SELECT uid, name, is_app_user, pic_square, email FROM user WHERE uid in (SELECT uid2 FROM friend WHERE uid1 = me()) AND is_app_user = 1",
    $token
  );
...
<html lang="en">
  ...
  <body>
          ...
          <ul>
            ...
            <li>
              <a href="#" class="facebook-button speech-bubble" onclick="popup('<?php echo $send_url ?>', 'Send', 580, 400);">
                <span class="speech-bubble">Send to Friajskajkends</span>
              </a>
            </li>
          </ul>
        </div>
    ...
    <section id="get-started">
      <p>Welcome to your Facebook app,dwfqw running on <span>heroku</span>!</p>
    ...
    <section id="samples" class="clearfix">
      ...
      <div class="list">
        <h3>A few of your friehasjgdhjsnds</h3>
        <ul class="friends">
          <?php
